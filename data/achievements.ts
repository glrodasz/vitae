import { AchievementSection } from "../types/data";
...
export const achievements: AchievementSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "NodeCo",
        text: "In the middle of the middleware",
        footer: "March 2019",
      },
      {
        title: "ReactJS Top",
        text: "The future of state management",
        footer: "March 2019",
      },
      {
        title: "Wordpress Medellín",
        text: "WooCommerce and React",
        footer: "October 2018",
      },
      {
        title: "Medellin JS",
        text: "How to quit using jQuery",
        footer: "May 2015",
      },
      {
        title: "Medellin PHP",
        text: "How to install Laravel in Codio",
        footer: "October 2014",
      },
    ],
  },
